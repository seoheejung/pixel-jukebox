...
document.querySelector('button').onclick=()=>{document.body.dataset.clicks=String(Number(document.body.dataset.clicks||0)+1);document.querySelector('#movie_player').classList.remove('ad-showing');};
</script>`;
let browser;
try {
  await until(async () => {
